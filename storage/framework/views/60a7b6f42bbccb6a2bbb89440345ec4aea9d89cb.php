        ...
        <span class="tag-box-new top-right flex-column">
            <?php if(!empty($item->badge)): ?>
                ...
                <?php if(!empty($campaign_percentage)): ?>
                    <span class="tag-new bg-black border-radius mt-0">
...
<?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/components/frontend/product/product-card-04.blade.php ENDPATH**/ ?>