...
<?php $__env->startSection('page-title'); ?>
    <?php if(!empty(request()->cat)): ?>
        <?php echo getSingleCategoryMarkup(request()->cat,true); ?>

    <?php endif; ?>
    <?php if(!empty(request()->subcat)): ?>
       <?php if(!empty(request()->cat)): ?> -> <?php endif; ?>   <?php echo getSingleSubCategoryMarkup(request()->subcat,true); ?>

    <?php endif; ?>
    <?php if(empty(request()->cat) && empty(request()->subcat)): ?>
                        ...
                        <div class="toolbox-right">
                            <div class="toolbox-item toolbox-show">
                                ...
                                <select id="set_item_to_show" class="select-box">
                                    <option value="8"
                                            <?php if($display_item_count == 8): ?> selected <?php endif; ?>><?php echo e(__('8')); ?></option>
                                    <option value="12"
                                            <?php if($display_item_count == 12): ?> selected <?php endif; ?>><?php echo e(__('12')); ?></option>
                                    <option value="16"
                                            <?php if($display_item_count == 16): ?> selected <?php endif; ?>><?php echo e(__('16')); ?></option>
                                    <option value="20"
                                            <?php if($display_item_count == 20): ?> selected <?php endif; ?>><?php echo e(__('20')); ?></option>
                                </select>
                            </div>
                            <div class="toolbox-item toolbox-sort">
                                ...
                                <select id="set_item_sort_by" class="select-box">
                                    <option value="default"
                                            <?php if($sort_by == 'default'): ?> selected <?php endif; ?>><?php echo e(__('Default sorting')); ?></option>
                                    <option value="popularity"
                                            <?php if($sort_by == 'popularity'): ?> selected <?php endif; ?>><?php echo e(__('Sort by popularity')); ?></option>
                                    <option value="latest"
                                            <?php if($sort_by == 'latest'): ?> selected <?php endif; ?>><?php echo e(__('Sort by latest')); ?></option>
                                    <option value="price_low"
                                            <?php if($sort_by == 'price_low'): ?> selected <?php endif; ?>><?php echo e(__('Sort by pric: low to high')); ?></option>
                                    <option value="price_high"
                                            <?php if($sort_by == 'price_high'): ?> selected <?php endif; ?>><?php echo e(__('Sort by pric: high to low')); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger d-flex justify-content-between"><?php echo e(__('no products found')); ?>

                            <a href="<?php echo e(route('frontend.products.all')); ?>" class="btn btn-warning btn-xs">
                ...
                <div class="col-lg-3">
                    <div class="widget-area-wrapper">
                        <?php if(get_static_option('shop_product_search')): ?>
                                ...
                                <form class="form-inline" id="search_form">
                                    <div class="form-group">
                                        <input type="search" class="form-control" id="search_query" name="search_query"
                                               placeholder="<?php echo e(__('search...')); ?>" value="<?php echo e(request()->q ?? ''); ?>">
                                    </div>
                        ...
                        <?php if(get_static_option('shop_filter_by_price')): ?>
                        ...
                        <?php if(get_static_option('shop_filter_by_category')): ?>
                            <div class="widget widget-category">
                                ...
                                <?php if(get_static_option('shop_filter_by_attributes')): ?>
                                                        ...
                                                        <div class="single-checkbox-wrap attribute">
                                                            <label>
                                                                <input type="radio" name="<?php echo e($attribute->title); ?>"
                                                                       ...
                                                                       data-attr-type="<?php echo e($attribute->id); ?>"
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if(get_static_option('shop_filter_by_average_rating')): ?>
                                            ...
                                            <div class="single-checkbox-wrap">
                                                <label>
                                                    <input type="radio" name="filter_rating" data-value="5"
                                                           ...
                                                           <?php if($searched_rating == 5): ?> checked <?php endif; ?>>
                                            ...
                                            <div class="single-checkbox-wrap">
                                                <label>
                                                    <input type="radio" name="filter_rating" data-value="4"
                                                           class="checkbox filter_rating"
                                                           <?php if($searched_rating == 4): ?> checked <?php endif; ?>>
                                                    <span class="checkmark">
                                        <i class="las la-star"></i>
                                        <i class="las la-star"></i>
                                        <i class="las la-star"></i>
                                            ...
                                            <div class="single-checkbox-wrap">
                                                <label>
                                                    <input type="radio" name="filter_rating" data-value="3"
                                                           class="checkbox filter_rating"
                                                           <?php if($searched_rating == 3): ?> checked <?php endif; ?>>
                                                    <span class="checkmark">
                                        <i class="las la-star"></i>
                                        <i class="las la-star"></i>
                                        <i class="las la-star"></i>
                                            ...
                                            <div class="single-checkbox-wrap">
                                                <label>
                                                    <input type="radio" name="filter_rating" data-value="2"
                                                           class="checkbox filter_rating"
                                                           <?php if($searched_rating == 2): ?> checked <?php endif; ?>>
                                                    <span class="checkmark">
                                        <i class="las la-star"></i>
                                        <i class="las la-star"></i>
                                        <i class="lar la-star"></i>
                                            ...
                                            <div class="single-checkbox-wrap">
                                                <label>
                                                    <input type="radio" name="filter_rating" data-value="1"
                                                           class="checkbox filter_rating"
                                                           <?php if($searched_rating == 1): ?> checked <?php endif; ?>>
                                                    <span class="checkmark">
                                        <i class="las la-star"></i>
                                        <i class="lar la-star"></i>
                                        <i class="lar la-star"></i>
                                ...
                                <?php if(get_static_option('shop_filter_by_tags')): ?>
                                    <div class="widget widget-tag">
                                        ...
                                        <div class="tag">
                                            <?php $__currentLoopData = $all_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="#"
                                                   class="tag-btn <?php if(request()->t == $tag->tag_text): ?> selected <?php endif; ?>"><?php echo e($tag->tag_text); ?></a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
        ...
        <form action="" id="sort_form" style="display: none">
            ...
            <input type="hidden" id="page" name="page" value="<?php echo e(request()->page ? request()->page : ''); ?>">
        </form>
        <?php $__env->stopSection(); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/frontend/product/all.blade.php ENDPATH**/ ?>