...
<div class="page-container">
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">v-<?php echo e(get_static_option('site_script_version','2.0.2')); ?></p>
        </div>
    </footer>
</div>
...
<?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>