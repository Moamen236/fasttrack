...
<script>
    $(document).on("click",".product_filter_style_two",function (){
        ...
        if($(this).attr("data-filter") == 'campaign'){
            send_ajax_response_get_response("post","<?php echo e(route("frontend.products.filter.campaign")); ?>",beforeSend,successResponse);
        }else if($(this).attr("data-filter") == 'new-items'){
            send_ajax_response_get_response("post","<?php echo e(route("frontend.products.filter.new")); ?>",beforeSend,successResponse);
        }else if($(this).attr("data-filter") == 'top-rated'){
            send_ajax_response_get_response("post","<?php echo e(route("frontend.products.filter.top.rated")); ?>",beforeSend,successResponse);
        }else if($(this).attr("data-filter") == 'top-selling'){
            send_ajax_response_get_response("post","<?php echo e(route("frontend.products.filter.top.selling")); ?>",beforeSend,successResponse);
        }else if($(this).attr("data-filter") == 'discounted'){
            send_ajax_response_get_response("post","<?php echo e(route("frontend.products.filter.discounted")); ?>",beforeSend,successResponse);
        }
    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.quick-view', function (e) {
                ...
                if (data['inStock']) {
                    stock_msg = "<?php echo e(__('Item is available in stock')); ?>";
...
<?php /**PATH C:\xampp\htdocs\fasttruck\@core\resources\views/frontend/partials/scripts/footer-scripts.blade.php ENDPATH**/ ?>