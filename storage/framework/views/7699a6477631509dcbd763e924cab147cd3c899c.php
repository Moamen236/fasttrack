<div class="blog-list-area-wrapper blog-grid-area-wrapper" data-padding-top="<?php echo e($padding_top); ?>" data-padding-bottom="<?php echo e($padding_bottom); ?>">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
...
<?php /**PATH /home/bytesed/public_html/laravel/zaika/@core/resources/views/PageBuilder/blog-list-page.blade.php ENDPATH**/ ?>