                ...
                <div class="product-view-wrap">
                    <div class="shop-details-gallery-slider" id="myTabContent">
                        <div class="single-main-image">
                            ...
                            <?php echo render_image_markup_by_attachment_id($product->image, 'img-fluid attribute_img', 'thumbnail'); ?>
                    ...
                    <div class="thumb-wrap">
                        <ul class="shop-details-gallery-nav">
                            ...
                            <?php if($product_image_gallery && count($product_image_gallery)): ?>
                                <?php $__currentLoopData = $product_image_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="single-thumb">
                                    <a class="thumb-link" data-toggle="tab" data-key="<?php echo e($loop->iteration + 1); ?>" href="#image-0<?php echo e($loop->iteration + 2); ?>" role="tab" aria-selected="true">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fasttruck\@core\resources\views/frontend/product/details.blade.php ENDPATH**/ ?>