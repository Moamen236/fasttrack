...
<nav class="navbar navbar-area navbar-expand-lg has-topbar nav-style-01 dark
    ...
    <?php if(!empty($page_post->navbar_variant)): ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
    <?php if( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 1): ?>
        nav-style-01
    <?php elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 2): ?>
        index-02 dark
    <?php elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 3): ?>

        has-topbar new-nav-style-01 new-index-03
    <?php elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 4): ?>
        has-topbar new-nav-style-01 new-index-04
    <?php elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 5): ?>
...
<!-- navbar area end -->
<?php /**PATH C:\xampp\htdocs\fasttruck\@core\resources\views/frontend/partials/navbar.blade.php ENDPATH**/ ?>