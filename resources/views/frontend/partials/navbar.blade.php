...
<nav class="navbar navbar-area navbar-expand-lg has-topbar nav-style-01 dark
    ...
    @if(!empty($page_post->navbar_variant))
        ...
        @endif
    @endif
    @if( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 1)
        nav-style-01
    @elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 2)
        index-02 dark
    @elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 3)
{{--        style-new-01 border-top footer-bg-color-01--}}
        has-topbar new-nav-style-01 new-index-03
    @elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 4)
        has-topbar new-nav-style-01 new-index-04
    @elseif( request()->routeIs('frontend.dynamic.page') && isset($page_post->navbar_variant) && $page_post->navbar_variant == 5)
