                ...
                <div class="product-view-wrap">
                    <div class="shop-details-gallery-slider" id="myTabContent">
                        <div class="single-main-image">
                            ...
                            {!! render_image_markup_by_attachment_id($product->image, 'img-fluid attribute_img', 'thumbnail') !!}
                        </div>
                        @php
                    ...
                    <div class="thumb-wrap">
                        <ul class="shop-details-gallery-nav">
                            ...
                            @if ($product_image_gallery && count($product_image_gallery))
                                @foreach ($product_image_gallery as $gallery_image)
                                <li class="single-thumb">
                                    <a class="thumb-link" data-toggle="tab" data-key="{{ $loop->iteration + 1 }}" href="#image-0{{ $loop->iteration + 2 }}" role="tab" aria-selected="true">
